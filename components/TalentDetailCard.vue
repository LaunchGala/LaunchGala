...
<template>
  ...
  class="bg-gradient-to-r from-orange-600 to-orange-400 p-6 flex flex-col items-center text-white">
        ...
        <span class="text-m opacity-90">{{profile?.talent?.headline}} </span>
      ...
      <CardContent class="p-6">
        ...
        <h2 class="font-semibold mb-4">Employment Type Seeking:</h2>
        <div v-for="category in profile?.talent?.employment_type" class="mb-6 flex gap-2 flex-wrap">
