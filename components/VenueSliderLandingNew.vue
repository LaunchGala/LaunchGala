    ...
    <div class=" mx-auto px-4 sm:px-6 lg:px-8 py-2 ">
      ...
      <div class="py-8 ">
        <NuxtLink to="AllVenues">
          <Button
            class="bg-orange-500 text-white border-2 border-orange-500 font-medium hover:bg-white hover:text-orange-500 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5 rounded-lg px-6 py-3">
            View All
