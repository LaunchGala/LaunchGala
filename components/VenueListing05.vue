        ...
        <Card>
          ...
          <CardContent>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Tooltip>
                <TooltipTrigger as-child>
                  <label @click="addEventTypes('Promotional Event')" class="flex flex-col items-center p-4 border rounded-lg shadow-sm cursor-pointer  hover:shadow-md focus-within:shadow-md focus-within:border-orange-500"
                  :class="{ 'bg-orange-100': props.venueListing.eventType.includes('Promotional Event'), 'bg-white': !props.venueListing.eventType.includes('Promotional Event') }">
                    <Palette class="w-6 h-6 mb-2 text-orange-500" />
                    <span class="text-lg font-semibold mb-1">Promotional Event</span>
                    <!-- <span class="text-sm dark:text-gray-300">Satellite channels</span> -->
                  </label>
                </TooltipTrigger>
                <!-- <TooltipContent>
              ...
              <Tooltip>
                <TooltipTrigger as-child>
                  <label @click="addEventTypes('Retail Sale')" class="flex flex-col items-center p-4 border rounded-lg shadow-sm cursor-pointer  hover:shadow-md focus-within:shadow-md focus-within:border-orange-500"
                  :class="{ 'bg-orange-100': props.venueListing.eventType.includes('Retail Sale'), 'bg-white': !props.venueListing.eventType.includes('Retail Sale') }">
                    <Palette class="w-6 h-6 mb-2 text-orange-500" />
                    <span class="text-lg font-semibold mb-1">Retail Sale</span>
                    <!-- <span class="text-sm dark:text-gray-300">Satellite channels</span> -->
                  </label>
                </TooltipTrigger>
                <!-- <TooltipContent>
          ...
          <Button @click="$emit('nextStep')" :disabled="!(props.venueListing.eventType?.length > 0)" variant="default" class="bg-white text-orange-500 border-orange-500 hover:bg-orange-100 font-bold ml-2">
            <div  class="flex items-center">
              Next
