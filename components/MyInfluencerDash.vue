...
<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white rounded-2xl shadow-sm mb-6">
      <div class="p-6"><div class="flex flex-row items-center justify-between"><h1 class="text-2xl font-bold text-gray-900">Influencer Management</h1> <NuxtLink to="profile" class="m-6 items-center">
        ...
        <div v-if="selectedBooking.id" class="bg-white rounded-xl shadow-sm border border-gray-100">
          <div class="p-6">
            ...
            <div class="mt-6 flex items-center justify-end space-x-3">
              ...
              :start-conversation-user-id="activeTab === 'requested' ? selectedBooking.influencer.id : selectedBooking.event.event_owner.id"></MessagesButton>
