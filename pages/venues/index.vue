...
const sizeOptions = ['Studio', '1 Bedroom', '2 Bedroom', '3+ Bedroom'];
const venueTypeOptions = ['Apartment', 'House', 'Condo'];
const amenitiesOptions = ['Pool', 'Gym', 'WiFi'];
const sponsorOptions = ['Sponsored', 'Non-Sponsored'];
  ...
  <div class="flex flex-col space-y-4 p-6 dark:bg-black">
      ...
      <CollapsibleContent class="space-y-4 pb-4">
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <Select>
            ...
            <SelectContent>
              <SelectItem v-for="option in sizeOptions" :key="option" :value="option">{{ option }}</SelectItem>
            </SelectContent>
          </Select>
          <Select>
            <SelectTrigger>
            ...
            <SelectContent>
              <SelectItem v-for="option in venueTypeOptions" :key="option" :value="option">{{ option }}</SelectItem>
            </SelectContent>
          </Select>
          <Select>
            <SelectTrigger>
            ...
            <SelectContent>
              <SelectItem v-for="option in amenitiesOptions" :key="option" :value="option">{{ option }}</SelectItem>
            </SelectContent>
          </Select>
          <Popover>
          ...
          <Select>
            ...
            <SelectContent>
              <SelectItem v-for="option in sponsorOptions" :key="option" :value="option">{{ option }}</SelectItem>
            </SelectContent>
          </Select>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
      <div v-for="venue in allVenues" :key="venue.id" class="bg-white rounded-lg shadow-md overflow-hidden dark:bg-gray-800">
        <div class="relative">
          <img class="w-full h-48 object-cover" :src="venue.images" alt="Apartment image" />
        ...
        <div class="px-4 py-4">          
          ...
          <h5 class="text-xl font-bold text-gray-900 dark:text-white">{{ venue.title }}</h5>
          <span class="text-l mt-2 text-gray-600 dark:text-gray-400">{{ venue.city }}, {{ venue.country }}</span>
        ...
        <div class="px-4 pt-2 pb-2">
          <NuxtLink to="VenueDetailPage">
            <Button class="mt-2 inline-flex items-center rounded-lg py-2 px-4 hover:bg-gray-200 transition-colors ButtonCol">
              Explore
