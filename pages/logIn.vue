<!-- pages/login.vue -->
<template>
  <div class="relative min-h-screen bg-center bg-cover" style="background-image: url('/Bootstrapping.png')">
...
// Add additional methods for other providers if needed
const signInWithApple = async () => {
  // Add sign-in logic for Apple
}

const signInWithLinkedin = async () => {
  // Add sign-in logic for LinkedIn
}
</script>
