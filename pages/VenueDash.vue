    ...
    <main class="flex-1 p-8">
      <Tabs default-value="requested-from-me" class="w-full">
        ...
        <TabsContent value="requested-from-me" class="space-y-6 ">
          ...
          <div v-for="item in feedItems" class="flex flex-col space-y-4 bg-white p-4 rounded-md shadow-xl transition-all ease-in-out duration-300 hover:-translate-y-1 hover:shadow-2xl dark:bg-[#1A1A1A] p-8">
